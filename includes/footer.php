      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">AIML </h2>
              <p>The Department of AIML will create high quality professionals in Artificial Intellegence and Machine Learning to foster leading edge research and to equip students to succeed and contribute to industry and society.</p>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text"> SJB Institute of Technology, Bengaluru,
                        Karnataka, India. </span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+91 9535688928</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">aiml2k24@gmail.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p>
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This website is made by SJBIT AIML
  </p>
          </div>
        </div>
      </div>
